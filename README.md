...
Sau khi làm sạch, dataset trở nên phù hợp cho việc phân tích. Tuy nhiên, do hai cột Payment Method và Location với mức độ nhiễu cao nên các phân tích liên quan đến hai biến này được hạn chế nhằm đảm bảo tính chính xác của kết quả.
